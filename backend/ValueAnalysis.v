...
- (* store *)
  ...
  { unfold Mem.storev in *. des_ifs. eapply Unreach.store_mle; eauto.
    ii. rr in HLE. desH HLE. ss. inv WF. exploit WFHI; eauto. i. exploit OLD; eauto. i; des_ifs; try xomega. des_sumbool.
...
+ (* private call *)
  ...
  * eapply sound_stack_private_call with (bound' := Mem.nextblock m) (bc' := bc); eauto.
    ...
    inv MM. exploit mmatch_below; eauto. { rewrite SP; ss. } i. xomega.
...
* (* private builtin call *)
  ...
  { hexploit sound_stack_unreach; eauto. i; des. hexploit external_call_nextblock; try eassumption. i.
    eapply Unreach.hle_update; try eassumption; ss; try xomega. i. try (des_ifs; try xomega; []). rewrite AA; try xomega; ss. }
* (* public builtin call *)
...
- (* return *)
  ...
  eapply mmatch_free; eauto.
  { hexploit sound_stack_unreach; eauto. i; des. erewrite Mem.nextblock_free; eauto.
    eapply Unreach.hle_update; try eassumption; ss; try xomega. i. try (des_ifs; try xomega; []). rewrite C; ss; try xomega. ii; clarify. xomega. }
...
- (* internal function *)
  ...
  { hexploit sound_stack_unreach; eauto. i; des. exploit Mem.alloc_result; eauto. i; clarify. erewrite Mem.nextblock_alloc; eauto.
    eapply Unreach.hle_update; try eassumption; ss; try xomega. i. try (des_ifs; try xomega; []). rewrite F; ss; try xomega. }
...
- (* external function *)
  ...
  { hexploit external_call_nextblock; eauto. i. eapply Unreach.mle_monotone; try eassumption. ss.
    ii. rr in HLE. desH HLE. ss. inv WF. exploit WFHI; eauto. i. exploit OLD; eauto. i; des_ifs; try xomega.
  }
  econstructor; eauto.
  ...
  { hexploit sound_stack_unreach; eauto. i; des. hexploit external_call_nextblock; eauto. i.
    eapply Unreach.hle_update; try eassumption; ss; try xomega. i. try (des_ifs; try xomega; []). rewrite B; ss; try xomega. }
...
- exact GE.
- exact NOSTACK.
- rr. ss. splits; i; des_ifs; try xomega. des_sumbool. ii. hexploit VALID; eauto.
- econs; eauto. ss.
Qed.
